...
const COPY = {
  zh: {
    ...
    inspirationDimensions: ["最先出现的画面", "你身处怎样的空间", "最靠近你的光、颜色或触感", "你最不想丢掉的感觉"],
    collapse: "收起",
    sendFeeling: "发送听感",
    sendingFeeling: "正在发送",
    closeComment: "关闭评论",
  ...
  en: {
    ...
    inspirationDimensions: ["The first image that appears", "The space you find yourself in", "The light, color, or texture closest to you", "The feeling you most want to preserve"],
    collapse: "Close",
    ...
    goalLabels: {
      "subject-scene": "What appears",
      "space-composition": "Where you are",
